.. container:: navheader
   ...
   +======================+======================+======================+
   | `Prev                | C                    |                      |
   |  <see-also.html>`__  | hapter 4. Publishing | `Next <data-manageme |
   |                      | Patterns             | nt-patterns.html>`__ |
   +----------------------+----------------------+----------------------+
...
.. container:: sect1
   ...
   *How do we temporarily or permanently remove some Linked Data from
   the web?*
   ...
   .. container:: sect2
      ...
      superceded, how can the new authoritative copy be referenced.
   ...
   .. container:: sect2
      ...
      Where a resource has moved to a new location, publish `Equivalence
      Links <equivalence-links.html>`__ between the old and the new
      resources.
...
.. container:: navfooter
   ...
   +----------------------+----------------------+----------------------+
   | `Prev                | `Up <publishi        |                      |
   |  <see-also.html>`__  | ng-patterns.html>`__ | `Next <data-manageme |
   |                      |                      | nt-patterns.html>`__ |
   +----------------------+----------------------+----------------------+
   | See Also             | `Ho                  |  Chapter 5. Data     |
   |                      | me <index-2.html>`__ | Management Patterns  |
   +----------------------+----------------------+----------------------+
