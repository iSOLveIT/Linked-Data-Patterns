...
then new locally minted URIs should be created from :ref:`Shared Keys <shared-keys>`.
...
to publish :ref:`Equivalence Links <equivalence-links>`.

Related
#######

-  :ref:`Shared Keys <shared-keys>`
