.. container:: navheader
   ...
   ============================= = ================================
   `Prev <url-slug.html>`__         `Next <custom-datatype.html>`__
   ============================= = ================================
...
.. container:: chapter
   ...
   .. container:: titlepage
      ...
      .. container::
         ...
         .. container::
            ...
            .. rubric:: Chapter 3. Modelling Patterns
               :name: chapter-3.-modelling-patterns
               :class: title
         ...
         .. container::
            ...
            .. container:: abstract
               ...
               **Abstract**
               ...
               is based on the decared old Entity-Attribute-Value (EAV)
               ...
               prefered term) on the web, just as we share data. This
   ...
   .. container:: toc
      ...
      **Table of Contents**
      ...
      `Index Resources <index-resources.html>`__
      `Label Everything <label-everything.html>`__
      `Link Not Label <link-not-label.html>`__
      `Multi-Lingual Literal <multi-lingual-literal.html>`__
      `N-Ary Relation <nary-relation.html>`__
      `Ordered List <ordered-list.html>`__
      `Ordering Relation <ordering-relation.html>`__
...
.. container:: navfooter
   ...
   +----------------------+----------------------+----------------------+
   | `Prev                |                      |  `Next <cust         |
   |  <url-slug.html>`__  |                      | om-datatype.html>`__ |
   +----------------------+----------------------+----------------------+
   | URL Slug             | `Ho                  |  Custom Datatype     |
   |                      | me <index-2.html>`__ |                      |
   +----------------------+----------------------+----------------------+
