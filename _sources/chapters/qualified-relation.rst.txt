.. container:: navheader
   ...
   | Qualified Relation   |                      |                      |
   +======================+======================+======================+
   | `Prev <prefe         | Chapter 3. Modelling |  `Next <reifie       |
   | rred-label.html>`__  | Patterns             | d-statement.html>`__ |
   +----------------------+----------------------+----------------------+
   ...
   .. container:: titlepage
      ...
      .. container::
         ...
         .. container::
            ...
            .. rubric:: Qualified Relation
               :name: qualified-relation
               :class: title

   *How can we describe or qualify a relationship between two
   resources?*
   ...
   .. container:: sect2
      ...
      some way. There are a number of different use cases that reuired
   ...
   .. container:: sect2
      ...
      model in this way can aid expressivity, understanding when and
...
.. container:: navfooter
   ...
   +----------------------+----------------------+----------------------+
   | `Prev <prefe         | `Up <modelli         |  `Next <reifie       |
   | rred-label.html>`__  | ng-patterns.html>`__ | d-statement.html>`__ |
   +----------------------+----------------------+----------------------+
   | Preferred Label      | `Ho                  |  Reified Statement   |
   |                      | me <index-2.html>`__ |                      |
   +----------------------+----------------------+----------------------+
