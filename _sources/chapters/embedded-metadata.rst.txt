.. container:: navheader
   ...
   +======================+======================+======================+
   | `Prev <              | C                    |  `Next <equiva       |
   | edit-trail.html>`__  | hapter 4. Publishing | lence-links.html>`__ |
   |                      | Patterns             |                      |
   +----------------------+----------------------+----------------------+
...
.. container:: sect1
   ...
   *How do we add structured data to an existing document or file?*
   ...
   .. container:: sect2
      ...
      Options vary for embedding metadata in other formats, but `Adobe
      XMP <#>`__ provides an option that can be used in a variety of
      formats.
   ...
   .. container:: sect2
      ...
      Embedding metadata into existing resources, rather than requring
...
.. container:: navfooter
   ...
   +----------------------+----------------------+----------------------+
   | `Prev <              | `Up <publishi        |  `Next <equiva       |
   | edit-trail.html>`__  | ng-patterns.html>`__ | lence-links.html>`__ |
   +----------------------+----------------------+----------------------+
   | Edit Trail           | `Ho                  |  Equivalence Links   |
   |                      | me <index-2.html>`__ |                      |
   +----------------------+----------------------+----------------------+
