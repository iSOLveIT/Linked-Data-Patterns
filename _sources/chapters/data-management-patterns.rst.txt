.. container:: navheader
   ...
   =================================== = =================================
   `Prev <unpublish.html>`__              `Next <graph-annotation.html>`__
   =================================== = =================================
...
.. container:: chapter
   ...
   .. container:: titlepage
      ...
      .. container::
         ...
         .. container::
            ...
            .. rubric:: Chapter 5. Data Management Patterns
               :name: chapter-5.-data-management-patterns
               :class: title
   ...
   .. container:: toc
      ...
      **Table of Contents**
      ...
      `Union Graph <union-graph.html>`__
...
.. container:: navfooter
   ...
   +----------------------+----------------------+----------------------+
   | `Prev                |                      |  `Next <graph        |
   | <unpublish.html>`__  |                      | -annotation.html>`__ |
   +----------------------+----------------------+----------------------+
   | Unpublish            | `Ho                  |  Graph Annotation    |
   |                      | me <index-2.html>`__ |                      |
   +----------------------+----------------------+----------------------+
